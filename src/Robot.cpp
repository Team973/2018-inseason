...
Robot::Robot()
    ...
    , m_clawLeftSolenoid(new Solenoid(CLAW_LEFT_PCM_ID))
    , m_clawRightSolenoid(new Solenoid(CLAW_RIGHT_PCM_ID))
    , m_ejectSolenoid(new Solenoid(CLAW_EJECT_PCM_ID))
    ...
    , m_claw(new Claw(this, m_logger, m_clawLeftSolenoid, m_clawRightSolenoid, m_ejectSolenoid))
    , m_intake(new Intake(this, m_logger, m_rightRoller, m_leftRoller, m_cubeSensor))
